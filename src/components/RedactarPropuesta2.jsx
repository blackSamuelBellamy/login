  ...
  return (
    <div className='maincontainer'>
      ...
      <div className='maincontainer-tecs'>
        ...
        <select id="languages" multiple onChange={handleLanguagesChange} style={{ width: '300px' }}>
      ...
      <div className='maincontainer-tecs'>
        ...
        <select id="frameworks" multiple onChange={handleFrameworksChange} style={{ width: '300px' } }>
      ...
      <div className='maincontainer-tecs'>
        ...
        <select id="databases" multiple onChange={handleDatabasesChange} style={{ width: '300px' }} >
